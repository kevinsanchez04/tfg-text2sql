...
def main(provider, force_thoughts=False, model=None):
    ...
    if accuracies:
        ...
        print("\n" + "=" * 60)
        print(f" EVALUATION FINISHED - BASELINE TOXICOLOGY")
        ...
        final_export = {
            "summary_metrics": {
                "experiment": "baseline_toxicology",
            ...
            "detailed_queries": logs # Each query's log
        }
        save_results(results=final_export, output_file="baseline_toxicology.json", base_folder="logs")
        print("All results saved successfully in 'logs/baseline_toxicology.json'")
